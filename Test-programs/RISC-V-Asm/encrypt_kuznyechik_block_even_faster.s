...
#     kuznk64rfwd x19, x3, x2 # R half result
#     kuznkdblsrl x3, x3, x2 # R shift in second half result
#     addi x28, x28, -1 # decrement counter
#     kuznk64rfwd x2, x3, x19 # R half result
#     kuznkdblsrl x3, x3, x19 # R shift in second half result
#     bne x28, zero, LSX_K_a_double_r_trans # if x28 != zero then LSX_K_odd_a_double_r_trans
#     # Hooray!!!!!! We've done it!!!!
    ...
    kuznkdblsrl x3, x3, x19 # R shift in second half result
    # 14 left
    kuznk64rfwd x19, x3, x2
    kuznkdblsrl x3, x3, x2
    kuznk64rfwd x2, x3, x19
    kuznkdblsrl x3, x3, x19
    # 12 left
    kuznk64rfwd x19, x3, x2
    kuznkdblsrl x3, x3, x2
    kuznk64rfwd x2, x3, x19
...
#     bne x28, zero, key_double_r_trans # if x28 != zero then lsx_double_r_trans
#     # Hooray!!!!!! We've done it!!!!
